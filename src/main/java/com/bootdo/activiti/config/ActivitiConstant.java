...
public class ActivitiConstant {
    ...
    public static final String ACTIVITI_AUDITER_2 = "auditer2";
    public static final String ACTIVITI_AUDITER_3 = "auditer3";
    public static final String ACTIVITI_AUDITER_4 = "auditer4";
}
